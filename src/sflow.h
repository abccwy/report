...
enum SFLCounters_type_tag {
	...
	/* A10 Enterprise */
	SFLCOUNTERS_DDOS_COUNTER = (40842 << 12) + 1,               // record enterprise: Type 1 T1 counters.
	SFLCOUNTERS_DDOS_IP_COUNTER = (40842 << 12) + 2,            // record enterprise: Type 2 T1 counters.
	SFLCOUNTERS_DDOS_HTTP_COUNTER = (40842 << 12) + 3,          // record enterprise: Type 3 T1 counters.
	SFLCOUNTERS_DDOS_DNS_COUNTER = (40842 << 12) + 4,           // record enterprise: Type 4 T1 counters.
	SFLCOUNTERS_DDOS_HTTP_IP_COUNTER = (40842 << 12) + 5,           // record enterprise: Type 5 T2 counters.
	SFLCOUNTERS_DDOS_DNS_IP_COUNTER = (40842 << 12) + 6,            // record enterprise: Type 6 T2 counters.
	SFLCOUNTERS_DDOS_L4_IP_COUNTER = (40842 << 12) + 7,         // record enterprise: Type 7 T2 counters.
	SFLCOUNTERS_DDOS_PORT_IP_COUNTER = (40842 << 12) + 8,           // record enterprise: Type 8 T2 counters.

	SFLCOUNTERS_DDOS_SSL_L4_COUNTER      = (40842 << 12) + 10,
	SFLCOUNTERS_DDOS_SSL_L4_T2_COUNTER   = (40842 << 12) + 11,
	SFLCOUNTERS_DDOS_ICMP_T2_COUNTER     = (40842 << 12) + 12,
	SFLCOUNTERS_DDOS_UDP_T2_COUNTER      = (40842 << 12) + 13,
	SFLCOUNTERS_DDOS_TCP_T2_COUNTER      = (40842 << 12) + 14,
	SFLCOUNTERS_DDOS_OTHER_T2_COUNTER    = (40842 << 12) + 15,
	SFLCOUNTERS_DDOS_L4_EXT_IP_COUNTER   = (40842 << 12) + 16,

	SFLCOUNTERS_DDOS_L4_TCP_COUNTER      = (40842 << 12) + 21,
	SFLCOUNTERS_DDOS_L4_UDP_COUNTER      = (40842 << 12) + 22,
	SFLCOUNTERS_DDOS_L4_ICMP_COUNTER     = (40842 << 12) + 23,
	SFLCOUNTERS_DDOS_L4_OTHER_COUNTER    = (40842 << 12) + 24,
	SFLCOUNTERS_DDOS_L4_SWITCH_COUNTER   = (40842 << 12) + 25,
	SFLCOUNTERS_DDOS_L4_SYNC_COUNTER     = (40842 << 12) + 26,
	SFLCOUNTERS_DDOS_L4_TUNNEL_COUNTER   = (40842 << 12) + 27,
	SFLCOUNTERS_DDOS_L4_SESSION_COUNTER  = (40842 << 12) + 28,
	SFLCOUNTERS_DDOS_L4_TABLE_COUNTER    = (40842 << 12) + 29,
	SFLCOUNTERS_DDOS_STATS_BRIEF_COUNTER = (40842 << 12) + 30,
	SFLCOUNTERS_DDOS_STATS_LONG_COUNTER  = (40842 << 12) + 31,


	SFLCOUNTERS_DDOS_FPGA_ANOMALY_COUNTER = (40842 << 12) + 9,      // record enterprise: Type 9 FPGA Anomaly counters.
	SFLCOUNTERS_DDOS_FLEX = (40842 << 12) + 50,                 // record enterprise: Type 50 flex for new generic.
	SFLCOUNTERS_DDOS_ENTRY_MAP = (40842 << 12) + 60,            // record enterprise: Type 60 entry_map.
	SFLCOUNTERS_DDOS_POLLING_PACKETS_COUNTER = (40842 << 12) + 64,  // record enterprise: Type 61 sflow_packets.
	SFLCOUNTERS_DDOS_POLLING_L4_COUNTER = (40842 << 12) + 65,       // record enterprise: Type 62 sflow_l4.
	SFLCOUNTERS_DDOS_POLLING_TCP_BASIC_COUNTER = (40842 << 12) + 66,    // record enterprise: Type 63 sflow_tcp_basic.
	SFLCOUNTERS_DDOS_POLLING_TCP_STATEFUL_COUNTER = (40842 << 12) + 67, // record enterprise: Type 64 sflow_tcp_stateful.
	SFLCOUNTERS_DDOS_POLLING_HTTP_COUNTER = (40842 << 12) + 68,     // record enterprise: Type 65 sflow_http http.

	/* A10 DDET */

	SFL_COUNTER_DDOS_DST_INDICATORS         = (40842 << 12) + 80,
	SFL_COUNTER_DDOS_DST_TCP_INDICATORS     = (40842 << 12) + 81,
	SFL_COUNTER_DDOS_DST_UDP_INDICATORS     = (40842 << 12) + 82,
	SFL_COUNTER_DDOS_DST_ICMP_INDICATORS    = (40842 << 12) + 83,
	SFL_COUNTER_DDOS_DST_OTHER_INDICATORS   = (40842 << 12) + 84,

        SFL_COUNTER_ACE_DDET_DST_COMM_INDICATORS = (40842 << 12) + 86,
        SFL_COUNTER_ACE_DDET_DST_TCP_INDICATORS  = (40842 << 12) + 87,

	SFL_COUNTER_REC_GENERIC_A10         = (40842 << 12) + 3000
